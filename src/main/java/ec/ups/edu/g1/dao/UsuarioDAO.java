...
public class UsuarioDAO {
	...
	public List<Usuario> ConsultarUsuarioTipo() {
		 String jpql = "SELECT * FROM miautransfer.usuario WHERE tipoUsuario='Administrador' OR tipoUsuario='Cajero' OR tipoUsuario='Jefe de credito'";
	...
	public List<Usuario> ConsultarUsuarioTipoCliente() {
		 String jpql = "SELECT * FROM miautransfer.usuario WHERE tipoUsuario='Cliente'";
			Query query = em.createNativeQuery(jpql, Usuario.class);
			List<Usuario> nivel = query.getResultList();
			return nivel;
	 }
	...
	public List<Usuario> ConsultarNumCuentaUsuario(String usuario) {
		 String jpql = "SELECT * FROM miautransfer.usuario WHERE emailUsuario=:usuario";
			Query query = em.createNativeQuery(jpql, Usuario.class);
	...
	public List<Usuario> ConsultarCuenta(String cuenta) {
		 String jpql = "SELECT * FROM miautransfer.usuario WHERE numCuenta=:cuenta";
			Query query = em.createNativeQuery(jpql, Usuario.class);
