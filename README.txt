...
a persistence unit "AtancuriJonathanOperadoraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "AtancuriJonathanOperadoraJEE\pom.xml":
...
artifact ("AtancuriJonathanOperadoraJEE.war") is already built. You can build
